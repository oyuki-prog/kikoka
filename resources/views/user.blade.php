            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg py-8 px-4 sm:px-8">
                <div class="sm:flex">
                    ...
                    <div class="sm:flex-1 sm:ml-8">
                        ...
                        <p class="block text-base">{!! nl2br(e($user->introduce)) !!}</p>
                    </div>
                </div>
                @if ($questions->count() != 0)
                    ...
                    @foreach ($questions as $question)
                        <div class="relative">
                            ...
                            <div
                                class="absolute top-0 left-0 w-20 h-8 border-4 border-gray-400 rounded @if ($question->open == true) bg-green-300 @else bg-gray-300 @endif text-center align-middle">
